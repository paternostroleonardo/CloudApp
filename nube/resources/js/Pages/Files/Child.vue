    ...
    <div class="overflow-auto">
       <table class="w-full">
         ...
         <tbody>
            ...
            <tr class="border-gray-100 border-b-2 hover:bg-gray-100" v-for="child in childrens">
               <td class="py-2 px-3 flex items-center">
                 ...
                 <Link :href="route('files.child', child.children[0].objeto.id)" class="p-2 font-bold text-blue-600 flex-grow">
                           {{ child.children[0].objeto.name }}
                  </Link>
                  <a class="p-2 font-bold text-blue-600 flex-grow">
                       <button class="text-gray-400 font-bold"> Renombrar </button>
                  </a>
               <td class="py-2 px-3">
                    {{ moment(child.children[0].objeto.created_at).format('L') }}
                </td>
